...
In addition to the two control rules applied for each IBM described above, the study design also included multiple variants of the OM.  Fully selected fishing mortality during the base period: 1) was constant at a level equal to $2.5F_{MSY}$ (always overfishing) or 2) equaled $2.5F_{MSY}$ in the first half of the base period then declined in a knife-edged fashion to $F_{MSY}$ for the second half of the base period. These patterns in fully-selected fishing mortality rate were based on observed patterns for Northeast groundfish (Wiedenmann et al. 2019). The two different fishing intensities during the latter half of the base period led to different starting conditions for the simulations.
