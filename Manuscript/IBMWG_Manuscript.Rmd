...
For catch misspecification, a scalar multiple of the true catch observation is provided to the IBMs. The scalar is 5 for fishing intensity *OF* and both selectivity patterns, 2.25 for fishing intensity *KF* and selectivity scenario *S2*, or 2.5 (for fishing history *KF* and selectivity *S1*. The shift in scalar trended linearly from 1 to the higher value between years 30 and 40 of the base period. Note that this scalar is applied only to the aggregate catch so that it affects all catches at age equally.
