...
Closed-loop simulation is a common tool for examining performance of catch advice from various stock assessment approaches in a feedback setting. It is often used as part of a full management strategy evaluation when working with stakeholders to develop management regulations that make trade offs between near term and long term catches, risk to the fish population, and mixed-fleet allocations [see e.g., @goethel2010mse; @carruthers2016simpleMPs; @harlyan2019hcr]. Although we were not able to conduct the a full management strategy evaluation with stakeholder input [@goethel2019stakeholder], we did have a wide range of expertise in the group and have presented our results to both local fishery management councils. Each closed-loop simulation is designed to address a specific situation. 
