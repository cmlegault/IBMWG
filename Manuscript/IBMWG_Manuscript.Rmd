...
We developed a management strategy evaluation (MSE) simulation model (e.g., Punt et al. 2016) to evaluate the suitability of alternative data-limited methods for setting target catches when stock assessments fail.
