...
newfiles <- myfiles[353:355] # can subset using brackets for testing, e.g., myfiles[1:3]
nfiles <- length(newfiles)

# defines names of files that are saved
mainfile_name <- "results/perform-metrics_clean_full_DLM.rds"
dbfile_name <- "results/dbfile_new_DLM.rds"
dbrowid_name <- "results/dbrowid_new_DLM.rds"
