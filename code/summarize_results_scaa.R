...
newfiles <- myfiles[246:278] # can subset using brackets for testing, e.g., myfiles[1:3]
nfiles <- length(newfiles)

# defines names of files that are saved
mainfile_name <- "results/perform-metrics_scaa.rds"
dbfile_name <- "results/dbfile_scaa.rds"
dbrowid_name <- "results/dbrowid_scaa.rds"
