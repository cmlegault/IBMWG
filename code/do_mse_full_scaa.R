...
#  future::plan(future::multisession)
  ...
  system("git pull")
  #progress <- readRDS(file = "settings/scaa_progress.rds")
  progress <- readRDS(file = "settings/full_scaa_progress.rds")
  ...
  saveRDS(progress, file = "settings/full_scaa_progress.rds")
  #commit back to the repo so other users don't duplicate your efforts
  system('git commit -am "updates scaa progress table"')
  system("git push")
  # #################################
  xx <- mse_sim_setup %>% 
    unnest(specs) %>% 
  ...
  #   I()
  # saveRDS(progress, "settings/scaa_progress.rds")
...
#   saveRDS(mse_check, file = "mse_check.rds")
  ...
  saveRDS(progress, file = "settings/full_scaa_progress.rds")
  #commit back to the repo so other users don't duplicate your efforts
  system('git commit -am "adds completed runs to scaa progress table"')
  system("git push")
  #################################
