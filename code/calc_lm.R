...
# uses cleaned performance metrics results 
...
lm_significance_table=rbind(SSB_lm,colnames(SSB_lm),F_lm,colnames(SSB_lm),catch_lm)
write.csv(lm_significance_table,file="tables_figs/lm_significance_table.csv")
