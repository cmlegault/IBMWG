...
source("demo_make_tables_figures.R", echo=FALSE, verbose=FALSE, local = knitr::knit_global())
s_met <- ssb_probs[ssb_probs$metric=="l_is_ge_bmsy",]
f_met <- f_probs[f_probs$metric=="l_is_less_fmsy",]
c_met <- catch_means[catch_means$metric=="l_avg_catch_msy",]
...
h1 <- heatmap(scf, scale="column", Colv=NA, margins=c(8,10))
