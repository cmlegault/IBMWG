...
png("demonstrations/tim/wham_asap_compare.png", family = "Times", units = "in", type = "cairo-png", height = 10, width = 8, res = 500)

par(oma = c(4,0,0,0), mar = c(1,5,1,1),mfrow = c(3,1))

plot(1970:2019, wham_sim$SSB/1000, type ='n', axes =FALSE, lwd = 2, xlab = "", ylab = "SSB (kmt)", cex.lab = 2)
grid(col = gray(0.7))
legend("topright", col = c(gray(0.7), "blue", "red"), lty = 2, lwd =2, legend = c("True", "WHAM", "ASAP"), cex = 1.5)
lines(1970:2019, wham_sim$SSB/1000, lwd = 2, lty = 2, col = gray(0.7))
lines(1970:2019, wham_fit$SSB/1000, lwd = 2, lty = 2, col = "blue")
lines(1970:2019, asap_fit$SSB/1000, lwd = 2, lty = 2, col = "red")
...
plot(1970:2019, wham_sim$NAA[,1], type ='n', axes =FALSE, lwd = 2, xlab = "", ylab = "Recruitment (x1000)", cex.lab = 2)
grid(col = gray(0.7))
#legend("topright", col = c(gray(0.7), "blue", "red"), lty = 2, lwd =2, legend = c("True", "WHAM", "ASAP"), cex = 1.5)
lines(1970:2019, wham_sim$NAA[,1], lwd = 2, lty = 2, col = gray(0.7))
lines(1970:2019, wham_fit$NAA[,1], lwd = 2, lty = 2, col = "blue")
...
axis(1, lwd = 2, cex.axis = 1.5)
axis(2, lwd = 2, cex.axis = 1.5)
mtext(side = 1, outer = TRUE, cex = 1.5, "Year", line = 3)
box(lwd = 2)
dev.off()
